...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        recommendedProducts.add(ProductModel("ปากกา", "ปากกาลื่น เขียนง่าย", 50.00, R.drawable.ic_pen))
        recommendedProducts.add(ProductModel("ไม้บรรทัด", "ไม้บรรทัด 30 ซม.", 35.00, R.drawable.ic_ruler))
        recommendedProducts.add(ProductModel("สมุดโน้ต", "สมุดโน้ตลายมินิมอล 80 หน้า", 120.00, R.drawable.ic_notebook))
        ...
        promotionsList.add(ProductModel("ชุดอุปกรณ์การเรียน Bundle A", "มีปากกา, ไม้บรรทัด, กล่องดินสอ, สมุดโน้ต", 259.00, R.drawable.bundle_a))
